...
main (int argc, char **argv)
{
  ...
  if (load_name == NULL) {
    ...
    if (oldschool) {
      ...
      printf (" !!!!!!! finish p4est new refine_level: %d level_shift: %d\n", refine_level, level_shift );
    }
  ...
  p4est_vtk_write_file (p4est, NULL, "timings_mynew");
#endif
...
#ifdef P4EST_TIMINGS_VTK
  p4est_vtk_write_file (p4est, NULL, "timings_refined");
#endif
...
#ifdef P4EST_TIMINGS_VTK
  p4est_vtk_write_file (p4est, NULL, "timings_balanced");
#endif
...
#ifdef P4EST_TIMINGS_VTK
  p4est_vtk_write_file (p4est, NULL, "timings_partitioned");
#endif
  P4EST_ASSERT (crc == p4est_checksum (p4est));
